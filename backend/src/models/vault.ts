...
const vaultSchema = new Schema(
  {
    ...
    color: { type: String, default: '#7a8597' }, // brand color for UI tile (fallback when no image)
    imageDataUrl: { type: String }, // base64 data URL of uploaded logo (resized client-side)
